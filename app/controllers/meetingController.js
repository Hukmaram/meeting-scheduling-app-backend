            ...
            newMeeting.save((err, newMeeting) => {
                if (err) {
                    ...
                    let sendEmailOptions = {
                        ...
                        subject: `Meeting Scheduled: ${newMeetingObj.meetingTopic}`,
                        html: `<h3> Your meeting is scheduled! </h3>
                              <br> Hi , ${newMeetingObj.hostName} has scheduled a meeting with you via MyMeet.
                              <br>  
                            <div class="card" style="width: 18rem;">
                              <div class="card-body">
                                  <h5 class="card-title"><i>Subject</i></h5>
                            ...
                            <div class="card" style="width: 18rem;">
                                <div class="card-body">
                                    <h5 class="card-title"><i>When</i></h5>
                            ...
                            <div class="card" style="width: 18rem;">
                                <div class="card-body">
                                    <h5 class="card-title"><i>Where</i></h5>
...
let updateMeetingFunction = (req, res) => {
    ...
    let updateMeeting = (meetingDetails) => {
        return new Promise((resolve, reject) => {
            ...
            MeetingModel.findOneAndUpdate({ 'meetingId': req.params.meetingId }, options,{new:true}).exec((err, result) => {
                if (err) {
                    console.log(err)
                    ...
                    let sendEmailOptions = {
                        ...
                        html: `<h3> Your meeting has been modified! </h3>
                              ...
                              <div class="card" style="width: 18rem;">
                                  <div class="card-body">
                                      <h5 class="card-title"><i>When</i></h5>
                                      <p class="card-text">${result.meetingStartDate}</p>
                                  </div>
                              </div>
